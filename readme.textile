...
* *ExpressionEngine 1.6.x:* upload the <code>cache_buster/pi.cache_buster.php</code> file to the <code>system/plugins</code> directory
* *ExpressionEngine 2.x:* upload the <code>cache_buster</code> directory to the <code>system/expressionengine/third_party</code> directory
