...
* *ExpressionEngine 1.6.x:* upload the <code>er_tweet_me/pi.er_tweet_me.php</code> file to the <code>system/plugins</code> directory
* *ExpressionEngine 2.x:* upload the <code>er_tweet_me</code> directory to the <code>system/expressionengine/third_party</code> directory
